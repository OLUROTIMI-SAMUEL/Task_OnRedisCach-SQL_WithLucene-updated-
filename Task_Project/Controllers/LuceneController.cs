...
namespace Task_Project.Controllers
{
    ...
    public class LuceneController : ControllerBase
    {
        ...
        [HttpGet("SearchById")]
        public ActionResult<List<Customers>> SearchById([FromQuery] int? id)
        {
            if (!id.HasValue)
            {
            ...
            List<Customers> results = _luceneService.SearchById(id.Value);
        ...
        public ActionResult<List<Customers>> SearchByName([FromQuery] string name)
        {
            ...
            List<Customers> results = _luceneService.SearchByName(name);
        ...
        public ActionResult<List<Customers>> SearchByAddress([FromQuery] string address)
        {
            ...
            List<Customers> results = _luceneService.SearchByAddress(address);
        ...
        public ActionResult<List<Customers>> SearchByEmail([FromQuery] string email)
        {
            ...
            List<Customers> results = _luceneService.SearchByEmail(email);
